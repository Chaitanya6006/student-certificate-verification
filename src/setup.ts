// Orchestrator for `npm run setup`. Brings up the devnet services this
// network needs, compiles the contract, then deploys (forwarding --network).
...
async function main(): Promise<void> {
  ...
  process.stdout.write(`\n→ Setting up student-certificate-verification on network: ${network}\n\n`);
